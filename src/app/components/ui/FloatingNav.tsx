...
export const FloatingNav = ({
    ...
    const handleScroll = () => {
      ...
      sectionElements.forEach((section, index) => {
        if (section) {
          ...
          if (!foundActive && rect.top <= 150 && rect.bottom >= 150) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "flex max-w-fit fixed top-0 inset-x-0 mx-auto border-b rounded-lg shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-[5000] px-10 py-5 bg-black-100 border-white/[0.2] items-center justify-center space-x-4",
        className
      )}
    >
